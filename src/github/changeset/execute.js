...
export function isNotImplementedChangeSetItem(changeItem) {
    ...
    switch (changeItem.type) {
        ...
        case "team-remove":
            await github.octokit.teams.deleteInOrg({
                org: changeItem.org,
                team_slug: (await lookup.getOrgTeam(changeItem.org, changeItem.team)).slug,
            });
            return true;
        case "team-add":
 ...
 */
export async function executeChangeSet(github, changes, reporter) {
